...
CBufferDC::CBufferDC(CWnd* pParent) : m_pParent(pParent) 
{
	ASSERT(pParent); //대상 윈도우에 대한 정보를 수집한다.   
	...
	m_MemoryBmp.CreateBitmap(m_RcClient.Width(), 
		m_RcClient.Height(),         
...
{ 
	...
	m_pTarget->BitBlt(m_PaintStruct.rcPaint.left,
